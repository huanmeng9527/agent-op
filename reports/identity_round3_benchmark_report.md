...
- Official repo top-3 hit rate: `0.8`
...
| `lightgcn_2020` | `False` | `True` | `False` | `True` | `False` | `official_recalled_not_top1` | `lucapantea/lightgcn`, `kuandeng/lightgcn`, `gusye1234/lightgcn-pytorch` |
...
| `deepspeech2_2015` | `False` | `False` | `False` | `False` | `False` | `official_repo_not_recalled` | `fd873630/deep_speech_2_korean`, `lizhaokun/autosub-with-baidu-deepspeech2`, `sooftware/deepspeech2` |
...
- `official_repo_not_recalled`: 1 cases; examples: `deepspeech2_2015`
...
- `speech`: 1 cases; examples: `deepspeech2_2015`
...
- `deepspeech2_2015` Deep Speech 2: End-to-End Speech Recognition in English and Mandarin: official_repo_not_recalled; retrieved: fd873630/deep_speech_2_korean, lizhaokun/autosub-with-baidu-deepspeech2, sooftware/deepspeech2
